...
- Generated: 2026-02-28T11:20:10-0500
- Runs: 6
- Scenarios: 10
...
- Runner: `mudmachine` (Windows 11, AMD64, py 3.12.12)
- Network: `unknown`
...
|---|---|---:|---:|---:|---:|
| openrouter | https://openrouter.ai/api/v1/models | 104.9 | 89.4 | 193.8 | 200 |
| ollama-local | http://localhost:11434/api/tags | 5038.7 | 5034.8 | 5046.3 | 200 |
## Rubric
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 35.3 | 0.4 | 0.00% | 0.0 | 0 |
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 36.8 | 0.4 | 0.00% | 0.0 | 0 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 37.0 | 0.4 | 0.00% | 0.0 | 0 |
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 37.7 | 0.3 | 0.00% | 0.0 | 0 |
| ollama-ministral-3b | local_server | ministral-3b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 37.9 | 0.4 | 0.00% | 0.0 | 0 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 42.7 | 0.3 | 0.00% | 0.0 | 0 |
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 35.3 | 0.4 | 0.00% | 0.0 | 0 | -30.071 |
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 36.8 | 0.4 | 0.00% | 0.0 | 0 | -30.074 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 37.0 | 0.4 | 0.00% | 0.0 | 0 | -30.075 |
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 37.7 | 0.3 | 0.00% | 0.0 | 0 | -30.076 |
| ollama-ministral-3b | local_server | ministral-3b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 37.9 | 0.4 | 0.00% | 0.0 | 0 | -30.076 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 42.7 | 0.3 | 0.00% | 0.0 | 0 | -30.086 |
...
|---|---:|---:|---:|---|
| Local | 6 | 37.4 | 35.3 | ollama-deepseek-r1-1.5b |
...
|---|---:|---|---|---:|---:|---:|
| local_server | 1 | ollama-deepseek-r1-1.5b | deepseek-r1:1.5b | 0.0 | 0.00% | -30.071 |
| local_server | 2 | ollama-gemma3-4b | gemma3:4b | 0.0 | 0.00% | -30.074 |
| local_server | 3 | ollama-phi4-mini | phi4-mini:latest | 0.0 | 0.00% | -30.075 |

## Recommendations

- Best overall quality: `ollama-deepseek-r1-1.5b` (deepseek-r1:1.5b)
- Best low-memory option: `ollama-mistral-nemo-12b` (0.3 MB peak)
- Best throughput option: `ollama-deepseek-r1-1.5b` (0.0 tokens/sec)
