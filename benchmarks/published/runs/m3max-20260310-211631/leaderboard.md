...
- Generated: 2026-03-10T21:18:56-0400
- Runs: 4
- Scenarios: 10
...
|---|---|---:|---:|---:|---:|
| openrouter | https://openrouter.ai/api/v1/models | 146.2 | 138.7 | 167.5 | 200 |
| ollama-local | http://localhost:11434/api/tags | 22.4 | 19.2 | 32.1 | 200 |
## Rubric
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| qwen3.5-0.8b-q8-intent | local_server | qwen/qwen3.5-0.8b | INTENT | 0.0 | 90.00% | 100.00% | 66.67% | 100.00% | 1395.4 | 775.9 | 0.00% | 20838.5 | 104.1 | 62943 |
| qwen3.5-0.8b-q4km-llm | local_server | qwen/qwen3.5-0.8b | LLM | 0.0 | 90.00% | 100.00% | 66.67% | 100.00% | 1395.8 | 0.4 | 0.00% | 21041.5 | 103.2 | 62943 |
| qwen3.5-0.8b-q8-llm | local_server | qwen/qwen3.5-0.8b | LLM | 0.0 | 90.00% | 100.00% | 66.67% | 100.00% | 1495.5 | 775.9 | 0.00% | 21111.5 | 104.2 | 65730 |
| qwen3.5-2b-q4km-llm | local_server | qwen/qwen3.5-2b | LLM | 0.0 | 90.00% | 100.00% | 66.67% | 100.00% | 1503.1 | 0.4 | 0.00% | 21065.6 | 104.5 | 65742 |
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| qwen3.5-0.8b-q4km-llm | local_server | qwen/qwen3.5-0.8b | LLM | 0.0 | 90.00% | 100.00% | 66.67% | 100.00% | 1395.8 | 0.4 | 0.00% | 21041.5 | 103.2 | 62943 | 85.376 |
| qwen3.5-2b-q4km-llm | local_server | qwen/qwen3.5-2b | LLM | 0.0 | 90.00% | 100.00% | 66.67% | 100.00% | 1503.1 | 0.4 | 0.00% | 21065.6 | 104.5 | 65742 | 85.161 |
| qwen3.5-0.8b-q8-intent | local_server | qwen/qwen3.5-0.8b | INTENT | 0.0 | 90.00% | 100.00% | 66.67% | 100.00% | 1395.4 | 775.9 | 0.00% | 20838.5 | 104.1 | 62943 | 83.825 |
| qwen3.5-0.8b-q8-llm | local_server | qwen/qwen3.5-0.8b | LLM | 0.0 | 90.00% | 100.00% | 66.67% | 100.00% | 1495.5 | 775.9 | 0.00% | 21111.5 | 104.2 | 65730 | 83.625 |
...
|---|---:|---:|---:|---|
| Local | 4 | 1445.6 | 1395.4 | qwen3.5-0.8b-q8-intent |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| local_server/qwen/qwen3.5-0.8b (qwen3.5-0.8b-q8_0.gguf) @ctx0 | 90.00% | 90.00% | +0.00% | 100.00% | 100.00% | +0.00% | 83.625 | 83.825 | +0.200 |

## Top 3 Per Provider

| Provider | Rank | Run | Model | Temp | Success | Score |
|---|---:|---|---|---:|---:|---:|
| local_server | 1 | qwen3.5-0.8b-q4km-llm | qwen/qwen3.5-0.8b | 0.0 | 90.00% | 85.376 |
| local_server | 2 | qwen3.5-2b-q4km-llm | qwen/qwen3.5-2b | 0.0 | 90.00% | 85.161 |
| local_server | 3 | qwen3.5-0.8b-q8-intent | qwen/qwen3.5-0.8b | 0.0 | 90.00% | 83.825 |

## Recommendations

- Best overall quality: `qwen3.5-0.8b-q8-intent` (qwen/qwen3.5-0.8b)
- Best low-memory option: `qwen3.5-0.8b-q4km-llm` (0.4 MB peak)
- Best throughput option: `qwen3.5-2b-q4km-llm` (104.5 gen tok/s)
- Routing gap summary: intent minus llm avg success delta = +0.00%
- Routing gap summary: intent minus llm avg score delta = +0.200
...
|---|---:|---:|
| qwen3.5-0.8b-q8-intent | 10.00 | 56.0% |
| qwen3.5-0.8b-q4km-llm | 9.96 | 56.0% |
| qwen3.5-0.8b-q8-llm | 11.36 | 48.0% |
| qwen3.5-2b-q4km-llm | 11.36 | 48.0% |
