...
- Generated: 2026-02-28T12:08:22-0500
- Runs: 5
- Scenarios: 10
...
|---|---|---:|---:|---:|---:|
| openrouter | https://openrouter.ai/api/v1/models | 165.2 | 81.3 | 352.8 | 200 |
| ollama-local | http://localhost:11434/api/tags | 5053.6 | 5022.3 | 5054.9 | 200 |
## Rubric
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 32.4 | 0.4 | 0.00% | 0.0 | 0 |
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 33.2 | 0.3 | 0.00% | 0.0 | 0 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 33.7 | 0.3 | 0.00% | 0.0 | 0 |
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 38.1 | 0.3 | 0.00% | 0.0 | 0 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 42.4 | 0.3 | 0.00% | 0.0 | 0 |
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 32.4 | 0.4 | 0.00% | 0.0 | 0 | -30.066 |
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 33.2 | 0.3 | 0.00% | 0.0 | 0 | -30.067 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 33.7 | 0.3 | 0.00% | 0.0 | 0 | -30.068 |
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 38.1 | 0.3 | 0.00% | 0.0 | 0 | -30.077 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 42.4 | 0.3 | 0.00% | 0.0 | 0 | -30.086 |
...
|---|---:|---:|---:|---|
| Local | 5 | 33.7 | 32.4 | ollama-gemma3-4b |
...
|---|---:|---|---|---:|---:|---:|
| local_server | 1 | ollama-gemma3-4b | gemma3:4b | 0.0 | 0.00% | -30.066 |
| local_server | 2 | ollama-llama3.2-3b | llama3.2:3b | 0.0 | 0.00% | -30.067 |
| local_server | 3 | ollama-phi4-mini | phi4-mini:latest | 0.0 | 0.00% | -30.068 |

## Recommendations

- Best overall quality: `ollama-gemma3-4b` (gemma3:4b)
- Best low-memory option: `ollama-deepseek-r1-1.5b` (0.3 MB peak)
- Best throughput option: `ollama-gemma3-4b` (0.0 tokens/sec)
