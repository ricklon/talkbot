...
- Generated: 2026-02-28T12:21:00-0500
- Runs: 5
- Scenarios: 10
...
|---|---|---:|---:|---:|---:|
| openrouter | https://openrouter.ai/api/v1/models | 114.1 | 106.9 | 206.9 | 200 |
| ollama-local | http://localhost:11434/api/tags | 5021.6 | 5020.5 | 5037.5 | 200 |
## Rubric
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 30.2 | 0.3 | 0.00% | 0.0 | 0 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 32.2 | 0.3 | 0.00% | 0.0 | 0 |
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 33.6 | 0.4 | 0.00% | 0.0 | 0 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 39.7 | 0.3 | 0.00% | 0.0 | 0 |
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 44.5 | 0.3 | 0.00% | 0.0 | 0 |
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 30.2 | 0.3 | 0.00% | 0.0 | 0 | -30.061 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 32.2 | 0.3 | 0.00% | 0.0 | 0 | -30.065 |
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 33.6 | 0.4 | 0.00% | 0.0 | 0 | -30.068 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 39.7 | 0.3 | 0.00% | 0.0 | 0 | -30.080 |
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 44.5 | 0.3 | 0.00% | 0.0 | 0 | -30.090 |
...
|---|---:|---:|---:|---|
| Local | 5 | 33.6 | 30.2 | ollama-deepseek-r1-1.5b |
...
|---|---:|---|---|---:|---:|---:|
| local_server | 1 | ollama-deepseek-r1-1.5b | deepseek-r1:1.5b | 0.0 | 0.00% | -30.061 |
| local_server | 2 | ollama-mistral-nemo-12b | mistral-nemo:latest | 0.0 | 0.00% | -30.065 |
| local_server | 3 | ollama-gemma3-4b | gemma3:4b | 0.0 | 0.00% | -30.068 |
