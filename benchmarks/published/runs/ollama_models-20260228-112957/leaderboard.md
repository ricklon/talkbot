...
- Generated: 2026-02-28T11:41:04-0500
- Runs: 6
- Scenarios: 10
...
|---|---|---:|---:|---:|---:|
| openrouter | https://openrouter.ai/api/v1/models | 125.9 | 72.5 | 201.1 | 200 |
| ollama-local | http://localhost:11434/api/tags | 5044.2 | 5037.9 | 5047.8 | 200 |
## Rubric
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 30.00% | 72.73% | 100.00% | 0.00% | 1297.0 | 0.4 | 4.00% | 268.6 | 8711 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 30.00% | 54.55% | 100.00% | 0.00% | 8221.1 | 0.4 | 5.88% | 227.6 | 46782 |
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 10.00% | 0.00% | 100.00% | 0.00% | 1754.5 | 0.4 | 0.00% | 93.2 | 4089 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 10.00% | 0.00% | 100.00% | 0.00% | 3303.8 | 0.3 | 0.00% | 616.3 | 50904 |
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 100.00% | 0.00% | 2637.3 | 0.4 | 0.00% | 204.5 | 13484 |
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 30.00% | 72.73% | 100.00% | 0.00% | 1297.0 | 0.4 | 4.00% | 268.6 | 8711 | 36.651 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 30.00% | 54.55% | 100.00% | 0.00% | 8221.1 | 0.4 | 5.88% | 227.6 | 46782 | 18.791 |
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 10.00% | 0.00% | 100.00% | 0.00% | 1754.5 | 0.4 | 0.00% | 93.2 | 4089 | 14.990 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 10.00% | 0.00% | 100.00% | 0.00% | 3303.8 | 0.3 | 0.00% | 616.3 | 50904 | 11.892 |
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 100.00% | 0.00% | 2637.3 | 0.4 | 0.00% | 204.5 | 13484 | 9.725 |
| ollama-ministral-3b | local_server | ministral-3b | LLM | 0.0 | 0.00% | 0.00% | 0.00% | 0.00% | 37.9 | 0.4 | 0.00% | 0.0 | 0 | -30.077 |
...
|---|---:|---:|---:|---|
| Local | 6 | 2195.9 | 37.9 | ollama-ministral-3b |
...
|---|---:|---|---|---:|---:|---:|
| local_server | 1 | ollama-llama3.2-3b | llama3.2:3b | 0.0 | 30.00% | 36.651 |
| local_server | 2 | ollama-mistral-nemo-12b | mistral-nemo:latest | 0.0 | 30.00% | 18.791 |
| local_server | 3 | ollama-gemma3-4b | gemma3:4b | 0.0 | 10.00% | 14.990 |

## Recommendations

- Best overall quality: `ollama-llama3.2-3b` (llama3.2:3b)
- Best low-memory option: `ollama-llama3.2-3b` (0.4 MB peak)
- Best throughput option: `ollama-llama3.2-3b` (268.6 tokens/sec)
