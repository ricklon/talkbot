...
- Generated: 2026-03-01T12:05:31-0500
- Runs: 6
- Scenarios: 10
...
|---|---|---:|---:|---:|---:|
| openrouter | https://openrouter.ai/api/v1/models | 93.9 | 84.6 | 226.7 | 200 |
| ollama-local | http://172.19.95.193:11434/api/tags | 31.2 | 25.0 | 44.2 | 200 |
## Rubric
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 50.00% | 81.82% | 100.00% | 100.00% | 968.7 | 0.4 | 10.71% | 250.6 | 6070 |
| ollama-qwen3-vl-8b | local_server | qwen3-vl:8b | LLM | 0.0 | 30.00% | 77.27% | 100.00% | 0.00% | 20256.8 | 0.4 | 0.00% | 118.5 | 60020 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 30.00% | 72.73% | 100.00% | 0.00% | 3382.7 | 0.4 | 0.00% | 572.6 | 48421 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 10.00% | 0.00% | 100.00% | 0.00% | 647.0 | 0.3 | 0.00% | 3114.6 | 50375 |
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 0.00% | 0.00% | 100.00% | 0.00% | 625.2 | 0.3 | 0.00% | 267.8 | 4185 |
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 100.00% | 0.00% | 2221.3 | 0.4 | 0.00% | 257.5 | 14298 |
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 50.00% | 81.82% | 100.00% | 100.00% | 968.7 | 0.4 | 10.71% | 250.6 | 6070 | 63.117 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 30.00% | 72.73% | 100.00% | 0.00% | 3382.7 | 0.4 | 0.00% | 572.6 | 48421 | 36.613 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 10.00% | 0.00% | 100.00% | 0.00% | 647.0 | 0.3 | 0.00% | 3114.6 | 50375 | 17.205 |
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 0.00% | 0.00% | 100.00% | 0.00% | 625.2 | 0.3 | 0.00% | 267.8 | 4185 | 13.749 |
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 100.00% | 0.00% | 2221.3 | 0.4 | 0.00% | 257.5 | 14298 | 10.557 |
| ollama-qwen3-vl-8b | local_server | qwen3-vl:8b | LLM | 0.0 | 30.00% | 77.27% | 100.00% | 0.00% | 20256.8 | 0.4 | 0.00% | 118.5 | 60020 | 0.440 |
...
|---|---:|---:|---:|---|
| Local | 6 | 1595.0 | 625.2 | ollama-gemma3-4b |
...
|---|---:|---|---|---:|---:|---:|
| local_server | 1 | ollama-llama3.2-3b | llama3.2:3b | 0.0 | 50.00% | 63.117 |
| local_server | 2 | ollama-mistral-nemo-12b | mistral-nemo:latest | 0.0 | 30.00% | 36.613 |
| local_server | 3 | ollama-phi4-mini | phi4-mini:latest | 0.0 | 10.00% | 17.205 |

## Recommendations

- Best overall quality: `ollama-llama3.2-3b` (llama3.2:3b)
- Best low-memory option: `ollama-llama3.2-3b` (0.4 MB peak)
- Best throughput option: `ollama-llama3.2-3b` (250.6 tokens/sec)
