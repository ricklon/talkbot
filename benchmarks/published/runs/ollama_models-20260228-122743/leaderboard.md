...
- Generated: 2026-02-28T12:33:39-0500
- Runs: 5
- Scenarios: 10
...
|---|---|---:|---:|---:|---:|
| openrouter | https://openrouter.ai/api/v1/models | 114.9 | 87.2 | 180.3 | 200 |
| ollama-local | http://localhost:11434/api/tags | 5040.4 | 5018.5 | 5040.6 | 200 |
## Rubric
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 40.00% | 77.27% | 100.00% | 0.00% | 1312.7 | 0.4 | 4.00% | 262.7 | 8620 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 30.00% | 63.64% | 100.00% | 0.00% | 7030.0 | 0.4 | 5.26% | 265.5 | 46670 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 10.00% | 0.00% | 100.00% | 0.00% | 1009.1 | 0.3 | 0.00% | 2012.0 | 50759 |
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 0.00% | 0.00% | 100.00% | 0.00% | 1294.3 | 0.3 | 0.00% | 130.0 | 4206 |
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 100.00% | 0.00% | 2999.0 | 0.4 | 0.00% | 195.7 | 14671 |
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| ollama-llama3.2-3b | local_server | llama3.2:3b | LLM | 0.0 | 40.00% | 77.27% | 100.00% | 0.00% | 1312.7 | 0.4 | 4.00% | 262.7 | 8620 | 41.028 |
| ollama-mistral-nemo-12b | local_server | mistral-nemo:latest | LLM | 0.0 | 30.00% | 63.64% | 100.00% | 0.00% | 7030.0 | 0.4 | 5.26% | 265.5 | 46670 | 23.115 |
| ollama-phi4-mini | local_server | phi4-mini:latest | LLM | 0.0 | 10.00% | 0.00% | 100.00% | 0.00% | 1009.1 | 0.3 | 0.00% | 2012.0 | 50759 | 16.481 |
| ollama-gemma3-4b | local_server | gemma3:4b | LLM | 0.0 | 0.00% | 0.00% | 100.00% | 0.00% | 1294.3 | 0.3 | 0.00% | 130.0 | 4206 | 12.411 |
| ollama-deepseek-r1-1.5b | local_server | deepseek-r1:1.5b | LLM | 0.0 | 0.00% | 0.00% | 100.00% | 0.00% | 2999.0 | 0.4 | 0.00% | 195.7 | 14671 | 9.001 |
...
|---|---:|---:|---:|---|
| Local | 5 | 1312.7 | 1009.1 | ollama-phi4-mini |
...
|---|---:|---|---|---:|---:|---:|
| local_server | 1 | ollama-llama3.2-3b | llama3.2:3b | 0.0 | 40.00% | 41.028 |
| local_server | 2 | ollama-mistral-nemo-12b | mistral-nemo:latest | 0.0 | 30.00% | 23.115 |
| local_server | 3 | ollama-phi4-mini | phi4-mini:latest | 0.0 | 10.00% | 16.481 |

## Recommendations

- Best overall quality: `ollama-llama3.2-3b` (llama3.2:3b)
- Best low-memory option: `ollama-llama3.2-3b` (0.4 MB peak)
- Best throughput option: `ollama-llama3.2-3b` (262.7 tokens/sec)
